...
console.log("Worldcore with Unity");
...
class BridgeToUnity {
    ...
    constructor() {
        ...
        this.startWS();
        this.measureIndex = 0;
        console.log("Starting BridgeToUnity interop layer");
        window.addEventListener("MessageFromUnity", (event) => {
            ...
            this.SendMessageToUnity("UnityMessageManager", "OnMessageReceivedFromJS", responseMessage);
          });
    }
...
const GameViewManager = class extends ViewService {
    constructor(name) {
...
const PM_GameDrivable = superclass => class extends superclass {
...
class GameViewRoot extends ViewRoot {
...
// the ViewRoot.
class GameInputManager extends ViewService {
    get gameViewManager() { return this._gameViewManager || (this._gameViewManager = GetViewService('GameViewManager')) }
