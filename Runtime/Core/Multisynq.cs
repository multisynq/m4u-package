...
public static class Croquet
{
    ...
    public static void Say(GameObject gameObject, string eventName)
    {
        ...
        Mq_Bridge.Instance.SendToCroquetSync("publish", scope, eventName);
    }
    ...
    {
        string scope = GetActorIdIfAvailable(gameObject);
        Mq_Bridge.Instance.SendToCroquetSync("publish", scope, eventName, "s", argString);
    }
    ...
    {
        string scope = GetActorIdIfAvailable(gameObject);
        Mq_Bridge.Instance.SendToCroquetSync("publish", scope, eventName, "ss", string.Join('\x03', argStrings));
    }
    ...
    {
        string scope = GetActorIdIfAvailable(gameObject);
        Mq_Bridge.Instance.SendToCroquetSync("publish", scope, eventName, "f", argFloat.ToString());
    }
    ...
    {
        string scope = GetActorIdIfAvailable(gameObject);
        Mq_Bridge.Instance.SendToCroquetSync("publish", scope, eventName, "ff", string.Join<float>('\x03', argFloats));
    }
    ...
    {
        string scope = GetActorIdIfAvailable(gameObject);
        Mq_Bridge.Instance.SendToCroquetSync("publish", scope, eventName, "b", argBool.ToString());
    }
    ...
    public static Action<string> Listen(GameObject gameObject, string eventName, Action handler)
    {
        ...
        Mq_Bridge.ListenForCroquetEvent(gameObject, scope, eventName, forwarder);
        return forwarder;
    }
    ...
    {
        string scope = GetActorIdIfAvailable(gameObject);
        Mq_Bridge.UnsubscribeFromCroquetEvent(gameObject, scope, eventName, forwarder);
    }
    ...
    {
        Mq_Entity_Comp entity = gameObject.GetComponent<Mq_Entity_Comp>();
    ...
    {
        Mq_Bridge.UnsubscribeFromCroquetEvent(scope, eventName, forwarder);
    }
    ...
    {
        return Mq_Entity_System.Instance.HasActorSentProperty(gameObject, propertyName);
    }
    ...
    {
        string stringVal = Mq_Entity_System.Instance.GetPropertyValueString(gameObject, propertyName);
        return stringVal;
    }
    ...
    {
        Mq_Bridge.Instance.SetSessionName(sessionName);
    }
    ...
    {
        return Mq_Bridge.Instance.CroquetSessionTime();
    }
    ...
    {
        Mq_Bridge.Instance.RequestToLoadScene(sceneName, forceReload, forceRebuild);
    }
}
