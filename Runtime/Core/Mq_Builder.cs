...
public class Mq_Builder {
  ...
  static public void WriteBuildIdentifierToAppFolder() {
    string buildIdentifier = CalculateBuildIdentifierFromAllCsAndJsSourceFiles();
    string code = @$"
      // This file is generated by the Croquet build process.  It contains a hash of all the
      // .cs and .js files in Assets/, except for StreamingAssets and this file.
  ...
  static string CalculateBuildIdentifierFromAllCsAndJsSourceFiles() {
    ...
    allFiles = allFiles.Where( f => !f.Contains( "buildIdentifier.js") && !f.Contains( "StreamingAssets" )
    ).ToList();
