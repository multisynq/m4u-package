...
public class Mq_Builder
{
    ...
    public static async Task<bool> InstallJSTools()
    {
        ...
        string croquetJSFolder = Path.GetFullPath(Path.Combine(Application.streamingAssetsPath, "..", "MultisynqJS"));
...
Then select Assets/Settings/Mq_Settings.asset in Unity Editor & set the 'Path To Node' value there.
{e.Message}");
            }
        }
